...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        boolean a = (abs(_col1 - _col0) == 1) && (abs(_row1 - _row0) <= 1);
        boolean b = ((abs(_col1 - _col0) <= 1) && (abs(_row1 - _row0) == 1));
        boolean c = (abs(_col1 - _col0) == 2) && (abs(_row1 - _row0) <= 2);
        boolean d = ((abs(_col1 - _col0) <= 2) && (abs(_row1 - _row0) == 2));
        _isExtend = (a || b);
        _isJump = (c || d);
    }
